...
public class Principal {
    ...
    static Persona futbolista1 = new Futbolista(10,"Delantero","Lionel","Messi",29);
    static Persona futbolista2 = new Futbolista(9,"Delantero","Edin","Dzeko",33);
    static Persona entrenador = new Entrenador("Conservador", "Alfonso", "Gómez", 63);
